package dev.parctice.order.infrastructure.order.gift;

import dev.parctice.order.domain.order.gift.GiftMessageChannelSender;
import dev.parctice.order.domain.order.gift.GiftPaymentCompleteMessage;
...
public class GiftMessageAwsSqsSender implements GiftMessageChannelSender {
    ...
    private final String SQS_QUEUE_NAME = "khs-order-payComplete-live.fifo"; // 생성한 AWS SQS fifo 이름
